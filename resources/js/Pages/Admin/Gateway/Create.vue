        ...
        <form @submit.prevent="store" enctype="multipart/form-data">
          <div class="card">
            <div class="card-body">
              ...
              <div class="mb-4">
                <label class="required" for="min_amount"> {{ trans('Minimum Amount') }}</label>
                <input
              ...
              <div class="mb-4">
                <label class="required" for="max_amount"> {{ trans('Maximum Amount') }}</label>
                <input
              ...
              <div class="mb-4">
                <label class="required" for="charge"> {{ trans('Gateway Charge') }}</label>
                <input
                  type="number"
                  step="any"
                  v-model="form.charge"
              ...
              <div class="mb-4">
                <label class="required" for="status"> {{ trans('Payment Instruction') }}</label>
                <textarea
