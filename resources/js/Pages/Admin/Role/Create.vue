...
const props = defineProps(['permissions_groups'])
  ...
  <div class="space-y-6">
    <div class="card">
      <div class="card-body">
        ...
        <hr />
        <div class="mt-3" v-for="(group, key) in permissions_groups" :key="group.key">
          <div class="grid grid-cols-12">
            ...
            <div :class="`col-span-9 role-${key}-management-checkbox`">
              ...
              >
                ...
                />
                <label class="label" :for="`checkPermission${permission.id}`">{{
                  permission.name
                }}</label>
              </div>
