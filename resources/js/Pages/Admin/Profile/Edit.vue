...
const updateProfile = (e) => {
  props.user.avatar = e.target.files[0]
  updateGeneral()
}
const updateGeneral = () => {
          ...
          <div class="card-body flex flex-col items-center">
            <div class="relative my-2 h-24 w-24 rounded-full">
              <form @submit="updateGeneral">
                ...
                <label
                  for="upload-avatar"
                  class="absolute bottom-4 right-4 flex h-7 w-7 cursor-pointer items-center justify-center rounded-full bg-slate-50 p-2 dark:bg-slate-900"
                >
                  <span class="text-slate-600 dark:text-slate-300">
                    <Icon icon="bx:camera" class="size-4" />
                  </span>
            ...
            >
              ...
              <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                <label class="label" for="first-name">
                  ...
                  <input type="text" class="input" v-model="user.name" id="last-name" />
                </label>
            ...
            <form @submit.prevent="updatePassword" class="flex flex-col gap-5">
              <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                ...
                <label class="label" for="new-password">
                  ...
                  <input type="password" class="input" v-model="form.password" id="new-password" />
                </label>
