...
import NestedDraggableSidebar from '@/Components/Dashboard/NestedDraggableSidebar.vue'
...
const props = defineProps(['info', 'contents', 'location'])
    ...
    <div class="col-span-1 w-full lg:col-span-4">
      <div class="card-body card">
        ...
        <form class="space-y-4">
          ...
          <div>
            <label for="text" class="label label-required">{{ trans('Icon') }}</label>
            <input
              type="text"
              class="input"
              placeholder="Icon"
