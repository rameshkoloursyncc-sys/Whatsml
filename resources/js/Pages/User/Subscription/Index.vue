...
const props = defineProps(['user', 'plans', 'orders', 'planByDays'])
...
<template>
  ...
  <div
    class="alert alert-danger mb-2 text-base"
  ...
  <div
    ...
    v-if="user.will_expire != null && user.plan_id"
  >
    ...
    <div
      class="col-span-1 flex flex-col gap-3 border-0 border-primary-400 p-4 sm:flex-row lg:col-span-5 lg:p-8 xl:border-l"
    >
