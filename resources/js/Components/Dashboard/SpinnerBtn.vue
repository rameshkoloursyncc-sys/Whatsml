...
<template>
  <button :type="type" :class="classes == '' ? defaultClasses : classes" :disabled="processing">
    ...
    <span class="flex items-center gap-1">
      <Icon v-if="icon && !processing" :icon="icon" class="mt-px min-h-4 min-w-4" />
      <span v-if="btnText" v-html="btnText"></span>
    </span>
  </button>
</template>
