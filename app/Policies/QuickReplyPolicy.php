...
class QuickReplyPolicy
{
    ...
    {
        return $user->id === $quickReply->owner_id;
    }
     ...
     */
    public function restore(User $user, QuickReply $quickReply): bool
    {
        return $user->id === $quickReply->owner_id;
    }
     ...
     */
    public function forceDelete(User $user, QuickReply $quickReply): bool
    {
        return $user->id === $quickReply->owner_id;
    }
}
